    ...
    <section className="relative py-32 lg:py-52 bg-slate-950 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        <FadeIn className="space-y-10">
          <div className="inline-flex items-center space-x-3 bg-brand-primary/10 text-brand-primary px-5 py-2 rounded-full border border-brand-primary/20 backdrop-blur-md">
          ...
          <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter italic text-white leading-none">
            UN LEADERSHIP <br />
            <span className="text-brand-primary">PAN-EUROPÉEN.</span>
          </h2>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mt-24">
             {[
               ...
               <motion.div 
                 ...
                 className="space-y-3"
               >
                 <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center text-brand-primary mx-auto mb-6 shadow-xl border border-white/5">{stat.icon}</div>
