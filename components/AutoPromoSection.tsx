...
const AutoPromoSection: React.FC = () => {
  ...
  return (
    <section className="relative py-20 lg:py-0 lg:h-[550px] bg-white dark:bg-slate-950 overflow-hidden flex items-center border-t border-slate-100 dark:border-slate-800">
          ...
          <div className="lg:col-span-6 space-y-8 lg:py-10">
            ...
            >
              <div className="inline-flex items-center space-x-3 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 px-4 py-2 rounded-xl border border-emerald-100 dark:border-emerald-500/20">
                <Car size={16} />
                <span className="text-[9px] font-black uppercase tracking-[0.2em]">{t('landing.auto_label')}</span>
              </div>
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-black leading-[0.9] tracking-tighter uppercase text-slate-950 dark:text-white italic">
                {t('landing.auto_title')} <span className="text-emerald-500">{t('landing.auto_highlight')}</span> <br />
                {t('landing.auto_subtitle')}
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <span className="text-[10px] font-black uppercase tracking-tight text-slate-700 dark:text-slate-300 leading-tight">TAEG FIXE <br/>DÈS 2.5%</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-[10px] font-black uppercase tracking-tight text-slate-700 dark:text-slate-300 leading-tight">RÉPONSE <br/>IMMÉDIATE</span>
              </motion.div>
            </div>
            ...
            >
              <StandardButton 
                onClick={() => navigate('/offres/auto')}
                className="!bg-emerald-500 hover:!bg-emerald-600 !px-8 !py-4 shadow-xl shadow-emerald-500/20 group"
              >
                <span className="font-black uppercase tracking-widest text-xs">{t('landing.auto_cta')}</span>
