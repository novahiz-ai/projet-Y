              ...
              <div className="relative bg-white dark:bg-slate-900/60 backdrop-blur-3xl border border-slate-200 dark:border-white/10 p-12 rounded-[4rem] shadow-3xl space-y-10 transform rotate-2 hover:rotate-0 transition-all duration-700">
                <div className="flex justify-between items-start">
                  <div className="space-y-2">
                    <h3 className="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">{t('project_loan.card.title')}</h3>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-end border-b border-slate-100 dark:border-white/5 pb-4">
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">{t('project_loan.card.cap_t')}</span>
                ...
                <div className="flex items-center space-x-3 text-slate-400">
                  ...
                  <span className="text-[11px] font-black uppercase tracking-widest">{t('project_loan.card.secure')}</span>
                </div>
              </div>
            </motion.div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {projectsItems.map((item: any, i: number) => (
                  <motion.div 
                    ...
                    className="group relative p-10 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[3.5rem] hover:border-cyan-500/40 transition-all duration-500 hover:shadow-2xl hover:shadow-cyan-500/5 flex flex-col justify-between min-h-[240px]"
                  >
                    <div className="space-y-6">
                      <div className="w-16 h-16 bg-white dark:bg-slate-800 text-cyan-600 rounded-3xl flex items-center justify-center shadow-sm group-hover:scale-110 group-hover:rotate-3 transition-all">
              ...
              <div className="bg-slate-950 py-24 px-10 md:px-20 rounded-[4.5rem] text-white overflow-hidden relative shadow-3xl">
                ...
                <div className="relative z-10 text-center space-y-20">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-16 relative">
                    <div className="hidden md:block absolute top-10 left-1/4 right-1/4 h-px bg-white/10"></div>
                    {processItems.map((step: any, i: number) => (
                      <div key={i} className="space-y-8 relative group">
                        <div className="w-20 h-20 bg-white/5 hover:bg-cyan-600 hover:text-white border border-white/10 rounded-3xl flex items-center justify-center mx-auto transition-all duration-500 backdrop-blur-md shadow-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {eligibilityItems.map((crit: any, i: number) => (
                  <div key={i} className="p-8 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[3rem] flex items-start space-x-6 group hover:border-cyan-500/30 transition-all">
                    <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center shrink-0 shadow-sm text-brand-primary group-hover:scale-110 transition-transform">
